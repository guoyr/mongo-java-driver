...
class BsonGeneratorSpecification extends Specification {
    ...
    def 'should generate BSON of stackedObjects'() {
        ...
        generator.with {
            ...
            writeFieldName('Test');
            writeStartObject();
            writeFieldName('Int64');
            writeNumber(5L);
            writeFieldName('data1')
            writeStartObject();
            writeFieldName('Int32');
            writeNumber(10);
            writeEndObject();
            writeFieldName('data3');
            writeStartObject();
    ...
    def 'should generate BSON of BigInteger as string'() {
        ...
        Math.abs(Double.valueOf(val) - Double.valueOf(3)) < 0.0001
